...
typedef enum keys : u8 {
  ...
  DEFINE_KEY(LBRACKET, 0xC1),
  DEFINE_KEY(RBRACKET, 0xC2),
} keys;
...
KAPI bool input_is_key_down(keys key);
KAPI bool input_is_key_up(keys key);
KAPI bool input_was_key_down(keys key);
KAPI bool input_was_key_up(keys key);

void input_process_key(keys key, bool pressed);

KAPI bool input_is_button_down(buttons button);
KAPI bool input_is_button_up(buttons button);
KAPI bool input_was_button_down(buttons button);
KAPI bool input_was_button_up(buttons button);
